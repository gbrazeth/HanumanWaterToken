Desenvolvimento do Smart Contract para lançamento do Hanuman Water Token (HWT).

O HWT é um token utilitário desenvolvido na Polygon projetado para transformar a gestão dos recursos hídricos. 
